...
pixi add nested-pandas
# for installing globally
pixi global install nested-pandas
```
...
It is possible to list all of the versions of `nested-pandas` available on your platform:
...
```
pixi search nested-pandas --channel conda-forge
```
